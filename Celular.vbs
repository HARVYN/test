...
WScript.Sleep 1500
MsgBox "INFECCIÓN MASIVA INICIADA", 16, "SISTEMA COMPROMETIDO"
WScript.Sleep 1500


oShell.Run "cmd /c echo Iniciando INCLUSION de amenazas... & ping -n 3 127.0.0.1 >nul & echo AMENAZAS DETECTADAS: 9 & echo INICIANDO INFECTACION... & ping -n 2 127.0.0.1 >nul & echo ERROR: Falla crítica", 1, True
...
htaFile.WriteLine "<div id='errorMsg'>Clave incorrecta. Intenta nuevamente.</div>"
htaFile.WriteLine "</div>"
